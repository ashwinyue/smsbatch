...
//go:generate mockgen -destination mock_post.go -package post github.com/ashwinyue/dcp/internal/apiserver/biz/v1/post PostBiz
...
import (
	...
	"github.com/ashwinyue/dcp/internal/apiserver/pkg/conversion"
