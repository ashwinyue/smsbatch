...
//go:generate mockgen -destination mock_job.go -package job github.com/ashwinyue/dcp/internal/nightwatch/biz/v1/job JobBiz
...
func (b *jobBiz) Update(ctx context.Context, rq *v1.UpdateJobRequest) (*v1.UpdateJobResponse, error) {
	...
	if rq.Params != nil {
		jobM.Params = (*model.JobParams)(rq.Params)
	}
	if rq.Results != nil {
		jobM.Results = (*model.JobResults)(rq.Results)
	}
	if rq.Status != nil {
