...
import (
	...
	store "github.com/ashwinyue/dcp/internal/apiserver/store"
...
func (m *MockIStore) ConcretePost() store.ConcretePostStore {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ConcretePost")
	ret0, _ := ret[0].(store.ConcretePostStore)
	return ret0
}
...
func (m *MockIStore) Post() store.PostStore {
	m.ctrl.T.Helper()
...
func (m *MockIStore) User() store.UserStore {
	m.ctrl.T.Helper()
