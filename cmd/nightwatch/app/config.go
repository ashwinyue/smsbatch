...
const (
	// defaultHomeDir 定义放置 nightwatch 服务配置的默认目录.
	defaultHomeDir = ".nightwatch"

	// defaultConfigName 指定 nightwatch 服务的默认配置文件名.
	defaultConfigName = "nightwatch.yaml"
)
